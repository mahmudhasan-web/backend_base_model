...
import parsePrismaValidationError from "../utilis/PrismaClinetValidation";
import handleClinetValidation from "../utilis/handleClinetValidation";
...
const GlobalErrorHandler = (
  ...
  // handle prisma client validation errors
    ...
    message = handleClinetValidation(err.message);
